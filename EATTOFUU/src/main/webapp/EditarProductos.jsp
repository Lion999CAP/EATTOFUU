...
<body>
  ...
  <main>
    ...
    <table>
            ...
            <td>
                <input type="text" id="codigo" name="editarcodigo" value="<%=cod %>" />
            </td>
            </tr>
            ...
            <td>
                <input type="text" id="categoria" name="editarcategoria" value="<%= mp.getCat() %>" />
            </td>
            </tr>
            ...
            <td>
                <input type="text" id="descripcion" name="editardescripcion" value="<%= mp.getNombre() %>" />
            </td>
            </tr>
            ...
            <td>
                <input type="text" id="precio" name="editarprecio" value="<%=mp.getPrecio() %>" />
            </td>
            </tr>
            ...
            <td>
                <input type="text" id="cantidad" name="editarcantidad" value="<%=mp.getCantidad() %>" />
            </td>
            </tr>
